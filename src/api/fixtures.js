const products = [
  ...
  { 'id': 2, 'title': 'Prune tari', 'titleRu':'Tвердые сливы', 'price': 55.00, 'inventory': 1000, 'shipping': 50.00, 'image_class': 'product-2', 'description':'Sunt cele mai sănătoase, bune pentru copii mici şi bunici.', 'descriptionRu': 'Они самые здоровые, хорошие для маленьких детей, бабушек и дедушек. <br> <br>' },
